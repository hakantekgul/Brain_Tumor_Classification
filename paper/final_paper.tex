...
\begin{figure}[h]
\centering
\includegraphics[scale=0.6]{figures/Image_size_distribution.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.4]{figures/Contrasting.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.4]{figures/Equalizing.png}
