...
\begin{figure}[h]
\centering
\includegraphics[scale=0.33]{figures/lpf.JPG}
\caption{Low pass filtered images.}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[scale=0.30]{figures/hpf.JPG}
\caption{High pass filtered images.}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[scale=0.33]{figures/lpf_hpf.JPG}
\caption{Low pass + high pass filtered images.}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[scale=0.4]{figures/median.JPG}
